...
const experiencesData = [
  {
    ...
    el: {
      ...
      description: "Από τα γαλαζοπράσινα νερά στα Άχλα και στον Ζόρκο μέχρι το εμβληματικό «Πήδημα της Γριάς». Η Άνδρος διαθέτει πάνω από 80 παραλίες, από οργανωμένες ακτές μέχρι απομονωμένους κόλπους. Σας προτείνουμε μια βουτιά στο Νειμποριό, λίγα βήματα μακριά μας, ή μια εκδρομή στην άγρια ομορφιά του Βιταλίου."
    },
    image: "/beach.jpg",
    reverse: false
  },
