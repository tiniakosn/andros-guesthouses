...
const experiencesData = [
  {
    ...
    el: {
      ...
      description: "Από τα γαλαζοπράσινα νερά της Άχλας και του Ζόρκου μέχρι το εμβληματικό «Πήδημα της Γριάς». Η Άνδρος διαθέτει πάνω από 80 παραλίες, από οργανωμένες ακτές μέχρι απομονωμένους κόλπους. Σας προτείνουμε μια βουτιά στο Νειμποριό, λίγα βήματα μακριά μας, ή μια εκδρομή στην άγρια ομορφιά του Βιταλίου."
    },
    image: "/beach.jpg",
    reverse: false
  },
  ...
  },
  {
    ...
    el: {
      title: "Γαστρονομία",
      description: "Ένα γαστρονομικό ταξίδι. Μην φύγετε χωρίς να δοκιμάσετε την παραδοσιακή «Φουρτάλια» (ομελέτα με ντόπια λουκάνικα), τα πικάντικα τυριά και τα περίφημα γλυκά του κουταλιού. Η Άνδρος προσφέρει μια πλούσια παράδοση που συνδυάζει κυκλαδίτικες γεύσεις με ηπειρωτικές επιρροές."
    },
    image: "/fourtalia.jpg",
    reverse: false
  }
    ...
    <main className="min-h-screen bg-[#fafaf9]">
      ...
      <div className="relative h-[60vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 mt-10">
          ...
          <Reveal delay={0.2}>
            <p key={lang + "hsub"} className="text-white/95 text-lg md:text-2xl max-w-2xl mx-auto font-sans font-light tracking-wide drop-shadow-md">
              {t.heroSub}
            </p>
          </Reveal>
        </div>
