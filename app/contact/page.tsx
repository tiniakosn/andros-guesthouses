      ...
      <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="space-y-10 mt-6">
            <Reveal>
              {/* FINAL FIX: Μικρότερο μέγεθος (text-6xl) και leading-normal */}
              <h1 className="text-4xl md:text-6xl font-display text-stone-900 leading-normal py-4">
                {t.title}
              </h1>
            </Reveal>
          ...
          <div className="lg:sticky lg:top-32 h-fit">
            <div className="bg-white p-8 md:p-12 rounded-2xl shadow-2xl border border-stone-100">
              <Reveal width="100%" delay={0.2}>
                ...
                <h3 className="text-3xl font-display text-stone-900 mb-2 leading-normal py-2">
                  {t.formTitle}
                </h3>
