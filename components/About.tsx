...
export default function About() {
  ...
  const content = {
    ...
    el: {
      ...
      p1: <>Είμαι ο <strong className="text-stone-900 font-bold">Λεωνίδας</strong>, ο περήφανος ιδιοκτήτης αυτού του οικογενειακού θησαυρού στην καρδιά της Χώρας. Μαζί με την <strong className="text-stone-900 font-bold">Εύα</strong> και τον <strong className="text-stone-900 font-bold">Νίκο</strong>, το πάθος μας πηγάζει από την αγάπη μας να μοιραζόμαστε την αυθεντική ομορφιά της Άνδρου.</>,
